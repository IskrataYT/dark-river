...
const OTPVerification = dynamic(
  () => import("@/components/auth/otp-verification"),
  {
    loading: () => (
...
const MFAVerification = dynamic(
  () => import("@/components/auth/mfa-verification"),
  {
    loading: () => (
      <div className="p-4 text-center text-zinc-400">
        Loading verification...
          ...
          <div className="mb-6 grid grid-cols-2 gap-px overflow-hidden rounded bg-zinc-800 text-xs sm:text-sm">
            <button
              ...
              className={`relative font-mono text-sm font-medium transition-colors ${
                !isSignUp
                  ? "bg-white py-3 text-black"
                  : "bg-black py-3 text-zinc-500 hover:text-zinc-300"
              }`}
              type="button"
            >
              ВХОД
